...
@LargeTest
public class CreditCardDateEditTextUiTest {

    @Rule
    public ActivityScenarioRule<CreditCardDateActivity> mActivityRule = new ActivityScenarioRule<>(CreditCardDateActivity.class);
     ...
     */
    @Test
    public void removeTrailingSeparator() {
     ...
     */
    @Test
    public void removePreviousCharacterWhenSeparatorDeleted() {
        // セパレーターを含む番号"01/2"を入力しておく
        onView(withId(R.id.credit_card_date))
                .perform(typeText("012"), closeSoftKeyboard())
                .check(matches(withText("01/2")))
     ...
     */
    @Test
    public void insertCharBeforeSeparator() {
     ...
     */
    @Test
    public void enterSeparatorAtHead() {
        // セパレーターを入力しても無視される
        onView(withId(R.id.credit_card_date))
     ...
     */
    @Test
    public void enterSeparatorAtTail() {
     ...
     */
    @Test
    public void enterSeparatorOnSeparator() {
     ...
     */
    @Test
    public void enterSeparatorOnSectionHead() {
        // セパレーターを含む番号"01/2"を入力しておく
        onView(withId(R.id.credit_card_date))
                .perform(typeText("012"), closeSoftKeyboard())
                .check(matches(withText("01/2")))
     ...
     */
    @Test
    public void enterSeparatorInSection() {
        // セパレーターを含む有効期限"01/2"を入力しておく
        onView(withId(R.id.credit_card_date))
                .perform(typeText("012"), closeSoftKeyboard())
                .check(matches(withText("01/2")))
    ...
    private static void sendToClipboard(final String text) throws InterruptedException {
        ...
        HandlerThread ht = new HandlerThread(CreditCardDateEditTextUiTest.class.getName());
        ht.start();
        ...
        h.post(new Runnable() {
            ...
            public void run() {
                ...
                clipboardManager.setPrimaryClip(ClipData.newPlainText(CreditCardDateEditTextUiTest.class.getName(), text));
                lock.countDown();
            }
        });
