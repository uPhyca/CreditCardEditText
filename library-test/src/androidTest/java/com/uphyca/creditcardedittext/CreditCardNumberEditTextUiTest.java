...
@LargeTest
public class CreditCardNumberEditTextUiTest {

    @Rule
    public ActivityScenarioRule<CreditCardNumberActivity> mActivityRule = new ActivityScenarioRule<>(CreditCardNumberActivity.class);
     ...
     */
    @Test
    public void enterSpaceOnSeparator() {
        // セパレーターを含む番号"4242 1110 2"を入力しておく
        onView(withId(R.id.credit_card_number))
                .perform(typeText("424211102"), closeSoftKeyboard())
                .check(matches(withText("4242 1110 2")))
     ...
     */
    @Test
    public void enterSpaceOnSectionHead() {
        // セパレーターを含む番号"4242 1110 2"を入力しておく
        onView(withId(R.id.credit_card_number))
     ...
     */
    @Test
    public void enterSpaceInSection() {
        // セパレーターを含む番号"4242 1110 2"を入力しておく
        onView(withId(R.id.credit_card_number))
                .perform(typeText("42421110"), closeSoftKeyboard())
                .check(matches(withText("4242 1110")))
    ...
    private static void sendToClipboard(final String text) throws InterruptedException {
        ...
        HandlerThread ht = new HandlerThread(CreditCardNumberEditTextUiTest.class.getName());
        ht.start();
        ...
        h.post(new Runnable() {
            ...
            public void run() {
                ...
                clipboardManager.setPrimaryClip(ClipData.newPlainText(CreditCardNumberEditTextUiTest.class.getName(), text));
                lock.countDown();
            }
        });
